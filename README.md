...
1. No VirgoDB account required: Download the ``catalogue_nfw.h5`` and ``mw_galaxies_catalogue_nfw.h5`` files from [here](https://doi.org/10.5281/zenodo.10491705), put it into the ``catalogue/RefL0100N1504/imbh/catalogue_nfw.h5`` and ``catalogue/RefL0100N1504/galaxy/mw_galaxies_catalogue_nfw.h5`` directories and use the ``calculate_flux.py`` script to calculate the gamma-ray flux for your desired dark matter masses or cross sections. See Section "Gamma-ray flux from dark matter self-annihilation" below for more details.
