...
if __name__ == '__main__':
    ...
    bh_plotter.plot_2d_map_contours(lat_sun, long_sun, path + "2d_map_sun_contours.pdf", upsampling = True, upsampling_factor = 1)

    # bh_plotter.plot_healpix_map(lat_sun, long_sun, path + "2d_healpix_map_sun.pdf")

    # # Plot a 2D gaussian pdf of the BH distribution
    # bh_plotter.plot_2d_map_gaussian(lat_sun, long_sun, path + "2d_map_sun_gaussian.pdf")
